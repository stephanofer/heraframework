...
public interface Placeholder {
     ...
     */
    void register(String startWith, BiFunction<Player, String, String> biConsumer, String description, String... args);
     ...
     * @param description The description of the placeholder.
     */
    void register(String startWith, Function<Player, String> biConsumer, String description);
