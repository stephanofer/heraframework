...
public class LogDateFilterButton extends Button {
    ...
    public LogDateFilterButton(AuctionPlugin plugin, String enableText, String disableText,
    ...
    public ItemStack getCustomItemStack(@NotNull Player player, boolean useCache, @NotNull Placeholders placeholders) {
        ...
        DateFilter currentFilter = cache.get(PlayerCacheKey.ADMIN_LOGS_DATE_FILTER, DateFilter.ALL);
    ...
    public void onClick(@NonNull Player player, @NonNull InventoryClickEvent event, @NonNull InventoryEngine inventory, int slot, @NonNull Placeholders placeholders) {
        ...
        cache.set(PlayerCacheKey.ADMIN_LOGS_DATE_FILTER, nextFilter);
