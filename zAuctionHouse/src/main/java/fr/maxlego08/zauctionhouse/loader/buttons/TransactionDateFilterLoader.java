...
public class TransactionDateFilterLoader extends ButtonLoader {
    ...
    public TransactionDateFilterLoader(AuctionPlugin plugin) {
        super(plugin, "ZAUCTIONHOUSE_ADMIN_TRANSACTIONS_FILTER_DATE");
        this.plugin = plugin;
    }
    ...
    public Button load(YamlConfiguration configuration, String path, DefaultButtonValue defaultButtonValue) {
        ...
        return new TransactionDateFilterButton(plugin, enableText, disableText, dateFilters, filterNames);
    }
}
